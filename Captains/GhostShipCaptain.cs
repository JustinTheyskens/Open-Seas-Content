...
namespace Server.Mobiles
{
    ...
    public class GhostShipCaptain : ShipEncounterCaptain
    {
        ...
        [Constructable]
        public GhostShipCaptain()
            : this(null)
        {
        }

        public GhostShipCaptain(BaseShip galleon)
            : base(galleon, AIType.AI_Mage, FightMode.Weakest, 25, 1, .2, .4)
        {
            Female = false;
            Name = GetRandomName();
            SpeechHue = Utility.RandomDyedHue();
            Title = "the ghostly captain";
            Hue = 2448;
            ...
            SetSkill(SkillName.EvalInt, 115.0, 120.0);
            SetSkill(SkillName.MagicResist, 115.0, 120.0);
            SetSkill(SkillName.Alchemy, 115.0, 120.0);
        ...
        public string GetRandomName()
        {
            ...
            {
                default:
                case 0: return NameList.RandomName("male");
                case 1: return NameList.RandomName("ethereal warrior");
                case 2: return NameList.RandomName("centaur");
            }
        ...
        public GhostShipCaptain(Serial serial)
            : base(serial)
        {
        }
