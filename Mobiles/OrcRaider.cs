...
namespace Server.Mobiles
{
    ...
    public class OrcRaider : BaseCreature
    {
        ...
        [Constructable]
        public OrcRaider() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, .2, .4)
        {
            Name = "an orcish raider";

            Body = 0.25 > Utility.RandomDouble() ? 0x8C : Utility.RandomList(0xB5, 0xB6);

            SetHits(2000);

            if (Body == 0x8C) // Mage or Necro
            {
                ...
                SetSkill(SkillName.Necromancy, 60.0, 70.0);
                SetSkill(SkillName.SpiritSpeak, 60.0, 75.0);
            }
        ...
        public OrcRaider(Serial serial)
            : base(serial)
        {
        }
